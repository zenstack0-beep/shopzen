...
export const THEMES = {
  // ── Warm / Fire
  default:   { name:'Ember Classic',    category:'warm',  primary:'#b5451b', primaryDark:'#8b3214', primaryLight:'#e8643c', accent:'#f0a500', dark:'#0f172a', surface:'#1e293b', gradient:'linear-gradient(135deg,#b5451b 0%,#e8643c 50%,#f0a500 100%)', heroGradient:'linear-gradient(135deg,#0f172a 0%,#1e293b 50%,#b5451b 100%)', cardBg:'#ffffff', bodyBg:'#fafaf8', darkCardBg:'#1e1e1e', darkBodyBg:'#0f0f0f' },
