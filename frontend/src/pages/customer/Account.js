...
export default function Account() {
  ...
  useEffect(() => {
    ...
    API.get('/auth/me').then(r => setProfile(p => ({ ...p, firstName: r.data.firstName, lastName: r.data.lastName, phone: r.data.phone||'' }))).catch(() => {});
  }, []);
                ...
                return (
                  <div key={order._id}
                    ...
                    style={{
                      ...
                      borderColor: isNew ? 'var(--color-primary)' : needsPayment ? '#fcd34d' : '#f3f4f6',
