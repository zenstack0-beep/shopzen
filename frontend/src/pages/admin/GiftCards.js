    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 overflow-y-auto"
      ...
      <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl" onClick={e => e.stopPropagation()}>
        ...
        <div className="p-5 space-y-4">
          ...
          {slipUrl ? (
            <div>
              <p className="text-xs font-semibold text-gray-500 mb-2 uppercase tracking-wide">Payment Slip</p>
              {isPdf ? (
                ...
                <a href={slipUrl} target="_blank" rel="noopener noreferrer">
                  <img src={slipUrl} alt="Payment slip"
                    className="w-full rounded-xl border border-gray-200 object-contain max-h-64 hover:opacity-90 transition-opacity"
